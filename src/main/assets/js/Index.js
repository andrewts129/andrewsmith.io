...
function Ball(x, y, radius, color) {
    ...
    this.draw = (context) => {
        ...
        const isVisible = () => !(this.p.x + this.radius < 0 || this.p.x - this.radius > width || this.p.y + this.radius < 0 || this.p.y - this.radius > height);
...
const buildBalls = () => Array.from({length: 15}, () => {
