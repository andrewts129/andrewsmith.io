...
object BogoStats {
  // An RDBMS is definitely not the best solution here. But it works and I already have one running on the
  // server so... ‾\_(ツ)_/‾
  ...
  object NumCompletions {
    ...
    def +=(n: Int): Unit = {
      // TODO figure out how to do this in one query... had trouble putting .toString() logic in the UPDATE query
      import ctx._
