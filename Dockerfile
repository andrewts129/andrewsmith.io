...
EXPOSE 8000
CMD svc/bin/start -Dhttp.port=8000 -Dplay.http.secret.key=$SECRET -Dpidfile.path=/dev/null -Dplay.evolutions.db.sqlite.autoApply=true -J-Xmx128m -J-XX:+UseContainerSupport
